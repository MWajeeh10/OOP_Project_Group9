...
//     SDL_Texture* redTokenTexture = loadTexture("C:\\Users\\786 COMPUTERS\\Documents\\GitHub\\OOP_Project_Group9\\assets\\tokens\\red1.png", renderer);
//     SDL_Texture* greenTokenTexture = loadTexture("C:\\Users\\786 COMPUTERS\\Documents\\GitHub\\OOP_Project_Group9\\assets\\tokens\\green1.png", renderer);
//     SDL_Texture* yellowTokenTexture = loadTexture("C:\\Users\\786 COMPUTERS\\Documents\\GitHub\\OOP_Project_Group9\\assets\\tokens\\yellow1.png", renderer);
//     SDL_Texture* blueTokenTexture = loadTexture("C:\\Users\\786 COMPUTERS\\Documents\\GitHub\\OOP_Project_Group9\\assets\\tokens\\blue1.png", renderer);
...
SoundManager::SoundManager() : buttonClickSound(nullptr) {
    buttonClickSound = Mix_LoadWAV("C:\\Users\\786 COMPUTERS\\Documents\\GitHub\\OOP_Project_Group9\\assets\\audio2.mp3"); // Update with the correct path
    if (!buttonClickSound) {
        std::cerr << "Failed to load button click sound effect! SDL_mixer Error: " << Mix_GetError() << std::endl;
    }
}
...
private:
    Mix_Music* welcomeMusic;
    Mix_Music* gameMusic;
};

MusicPlayer::MusicPlayer() : welcomeMusic(nullptr), gameMusic(nullptr) {
    if (Mix_OpenAudio(44100, MIX_DEFAULT_FORMAT, 2, 2048) < 0) {
        std::cerr << "SDL_mixer could not initialize! SDL_mixer Error: " << Mix_GetError() << std::endl;
    }

    welcomeMusic = Mix_LoadMUS("C:\\Users\\786 COMPUTERS\\Documents\\GitHub\\OOP_Project_Group9\\assets\\audio1.mp3"); // Update with the correct path
    gameMusic = Mix_LoadMUS("C:\\Users\\786 COMPUTERS\\Documents\\GitHub\\OOP_Project_Group9\\assets\\audio.mp3");       // Update with the correct path

    if (!welcomeMusic || !gameMusic) {
...
void MusicPlayer::playWelcomeMusic() {
    if (welcomeMusic) {
        Mix_PlayMusic(welcomeMusic, -1);
    }
}
...
class WelcomeScreen {
public:
    WelcomeScreen(SoundManager& soundManager, MusicPlayer& musicPlayer);
    ~WelcomeScreen();
...
WelcomeScreen::WelcomeScreen(SoundManager& soundManager, MusicPlayer& musicPlayer)
    : soundManager(soundManager), musicPlayer(musicPlayer) {
}
...
void WelcomeScreen::show(SDL_Renderer* renderer, ScreenType& nextScreen) {
    ...
    // Free the music at the end
    Mix_FreeMusic(musicPlayer.getWelcomeMusic());
}
    // ... rest of your code
...
public:
    PlayerSelectionScreen(SDL_Renderer* renderer, SoundManager& soundManager, MusicPlayer& musicPlayer);
...
private:
    ...
    // Helper functions for loading and rendering textures
    SDL_Texture* loadTexture(const std::string& path, SDL_Renderer* renderer);
    void renderTexture(SDL_Texture* texture, SDL_Renderer* renderer, int x, int y);

    // ... other members from your original code
};

// Constructor
PlayerSelectionScreen::PlayerSelectionScreen(SDL_Renderer* renderer, SoundManager& soundManager, MusicPlayer& musicPlayer)
    : soundManager(soundManager), musicPlayer(musicPlayer), dice1(nullptr), dice2(nullptr), dice3(nullptr), dice4(nullptr),
      redToken(nullptr), greenToken(nullptr), yellowToken(nullptr), blueToken(nullptr), currentTurn(Turn::DICE1) {
    // Initialize your existing members here or in an initialization list
    // Example: dice1 = new Dice(renderer, {"path1", "path2", ...}, x, y);
        dice1 = new Dice(renderer, {"C:\\Users\\786 COMPUTERS\\Documents\\GitHub\\OOP_Project_Group9\\assets\\dices\\red\\red1.png", 
                               "C:\\Users\\786 COMPUTERS\\Documents\\GitHub\\OOP_Project_Group9\\assets\\dices\\red\\red2.png", 
                               "C:\\Users\\786 COMPUTERS\\Documents\\GitHub\\OOP_Project_Group9\\assets\\dices\\red\\red3.png", 
                               "C:\\Users\\786 COMPUTERS\\Documents\\GitHub\\OOP_Project_Group9\\assets\\dices\\red\\red4.png",
...
PlayerSelectionScreen::~PlayerSelectionScreen() {
    ...
    // Cleanup the third Dice object
    if (dice3) {
        delete dice3;
    }

    // Cleanup the fourth Dice object
    if (dice4) {
        delete dice4;
    }
